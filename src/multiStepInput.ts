...
export class MultiStepInput {
	...
	async showInputBox<P extends InputBoxParameters>({ title, step, totalSteps, value, prompt, validate, buttons, ignoreFocusOut, placeholder, password, shouldResume }: P) {
		const disposables: Disposable[] = [];
		try {
